...
/*
	Usage:
		...
		$ go run part6/part6.go -private -dial localhost:4001 -port 4000
		// say something in part6
...
var self string
var dialQueue = make(chan Message)
...
func Communicate(out io.Writer) {
	enc := json.NewEncoder(out)
	for msg := range dialQueue {
		err := enc.Encode(msg)
		if err != nil {
			log.Fatal(err)
		}
